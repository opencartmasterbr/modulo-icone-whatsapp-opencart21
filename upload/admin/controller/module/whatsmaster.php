<?php
class ControllerModuleWhatsmaster extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('module/whatsmaster');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/whatsmaster', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('module/whatsmaster', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('module/whatsmaster.tpl', $data));
	}
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/whatsmaster')) {
